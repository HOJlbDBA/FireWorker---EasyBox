...
<main>
<h1 id="h1_box" style="margin-bottom: 10px">Школьный бокс</h1>
<div class="modalBox">
<div id="mr">
...
<figcaption>Easy box - путеводитель ваших эмоций и впечатлений💛</figcaption>
    ...
    <div>
    <p>Изи бокс "School" для самых прилежных обучающихся. Тут все необходимое для школьных будней. Именно то, что скрасит даже самые скучный урок.</p>
    <p>Блокноты, ручки, ластики, ланч-боксы, дневники, линейки и даже сладкие перекусы. Тот самый бокс, который будет актуален с 1 сентября и целый год.</p>
...
<input class="btn b_buy" type="submit" onclick="cart.addToCart(13, {title: 'SchoolBox', price: 3999})" value="В корзину">
</div>
</div>
</main>
<?php

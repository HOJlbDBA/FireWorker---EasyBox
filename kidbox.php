...
<main>
<h1 id="h1_box" style="margin-bottom: 10px">Детский бокс</h1>
<div class="modalBox">
<div id="mr">
<img style="margin-top:10px;" src="img/gifts/kidbox.jpg">
<figcaption>Easy box - путеводитель ваших эмоций и впечатлений💛</figcaption>
</div>
    <div>
    <p>Изи бокс "Kids" специально для самых юных любителей сюрпризов. Здесь вы найдёте трендовые игрушки, сладости, канцелярию, рюкзаки, подставки для телефона и многое другое с персонажами из мультиков. </p>
    <p>Вариант подарка на любой праздник, который заценит даже самый маленький получатель.</p>
...
<input class="btn b_buy" type="submit" onclick="cart.addToCart(2, {title: 'KidBox', price: 2999})" value="В корзину">
</div>
</div>
</main>
<?php
